...
traci.close()
# t = traci.trafficlight.getIDList()
# t1 = traci.trafficlight.getIDCount()
# t2 = traci.trafficlight.getRedYellowGreenState('50000')
# t3 = traci.trafficlight.getPhaseDuration('50000')
# t4 = traci.trafficlight.getControlledLinks('50000')
# t5 = traci.trafficlight.getControlledLanes('50000')
# t6 = traci.trafficlight.getPhase ('50001')
...
# t1 = traci.trafficlight.setRedYellowGreenState ('50000', 'rryyG')
# t2 = traci.trafficlight.setLinkState ('50000', 1, 'rryyG')
# t3 = traci.trafficlight.setPhase ('50000', 1)
# t4 = traci.trafficlight.setProgram ('50000','programname') ???????
# t5 = traci.trafficlight.setPhaseDuration ('50000', 0.25)
