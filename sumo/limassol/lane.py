...
# t1 = traci.lane.getIDList()
# t2 = traci.lane.getIDCount()
...
# t8 = traci.lane.getLength('gneE11_0')
# t9 = traci.lane.getMaxSpeed('gneE11_0')
# t10 = traci.lane.getShape('gneE11_0')
# t11 = traci.lane.getWidth('gneE11_0')
# t12 = traci.lane.getCO2Emission('gneE11_0')
# t13 = traci.lane.getCOEmission('gneE11_0')
# t14 = traci.lane.getHCEmission('gneE11_0')
# t15 = traci.lane.getPMxEmission('gneE11_0')
# t16 = traci.lane.getNOxEmission ('gneE11_0')
# t17 = traci.lane.getFuelConsumption ('gneE11_0')
# t18 = traci.lane.getNoiseEmission ('gneE11_0')
...
# t1 = traci.lane.setAllowed(":1212820385_3_0",['tram', 'rail_urban', 'rail'])
# t2 = traci.lane.setDisallowed(":1212820385_3_0",['tram', 'rail_urban', 'rail'])
# t3 = traci.lane.setLength(":1212820385_3_0",15.6)
# t4 = traci.lane.setMaxSpeed(":1212820385_3_0",8.6)
